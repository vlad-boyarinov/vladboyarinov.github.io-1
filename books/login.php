...
<div class="wrapper">
    ...
    <form class="form" action="include/signin.php" method="POST">
        <label class="form__login login" for="">Логин</label>
        <input class="form__login__input" name="login" type="text" placeholder="Введите логин" required>
        ...
        <button type="submit" class="form__button-enter">Войти</button>
        <p class="form__new-user"> Нет аккаунта - <a class="form__new-user__link" href="/registr.php">зарегистрируйся!</a></p>
        <?php
        if ($_SESSION['message']) {
